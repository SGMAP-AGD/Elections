...
* [Le réseau des données de l'INA](https://twitter.com/coulmont/status/569835256179781632) par @coulmont et le [code R](https://github.com/SGMAP-AGD/Elections/blob/master/projet-ina/data-ina.R)
...
* [QGIS + tutoriel](https://github.com/qgis/QGIS) Un logiciel de cartographie assez puissant basé sur python, notamment conseillé par l'INSEE pour l'utilisation des shapefiles. [Un tutoriel chez Sigea](http://sigea.educagri.fr/tutoriels-de-logiciels-sig/tutoriels-qgis.html).
